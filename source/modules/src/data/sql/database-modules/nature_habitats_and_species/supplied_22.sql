BEGIN; SELECT system.load_table('nature.habitat_types', '{data_folder}/public/habitat_types_20220607.txt', FALSE); COMMIT;
BEGIN; SELECT system.load_table('nature.habitat_type_critical_levels', '{data_folder}/public/habitat_type_critical_levels_20220607.txt', FALSE); COMMIT;
...
BEGIN; SELECT system.load_table('nature.habitat_areas', '{data_folder}/public/habitat_areas_20220603.txt', FALSE); COMMIT;
