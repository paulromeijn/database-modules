...
BEGIN; SELECT system.load_table('nature.habitat_type_critical_levels', '{data_folder}/public/habitat_type_critical_levels_20231120.txt'); COMMIT;
...
BEGIN; SELECT system.load_table('nature.habitat_areas', '{data_folder}/public/habitat_areas_20240530.txt'); COMMIT;
